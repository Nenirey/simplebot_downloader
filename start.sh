...
python3 -m simplebot --account "$ADDR" db -s simplebot_downloader/max_size 30485760
python3 -m simplebot --account "$ADDR" db -s simplebot_downloader/part_size 1048576
